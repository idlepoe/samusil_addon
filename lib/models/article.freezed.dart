...
@JsonKey(fromJson: _toString) String get key;@JsonKey(fromJson: _toString) String get board_name;@JsonKey(fromJson: _toString) String get profile_key;@JsonKey(fromJson: _toString) String get profile_name;@JsonKey(fromJson: _toInt) int get count_view;@JsonKey(fromJson: _toInt) int get count_like;@JsonKey(fromJson: _toInt) int get count_unlike;@JsonKey(fromJson: _toInt) int get count_comments;@JsonKey(fromJson: _toString) String get title; List<ArticleContent> get contents;@JsonKey(fromJson: _toString) String get created_at; bool get is_notice; String? get thumbnail;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,key,board_name,profile_key,profile_name,count_view,count_like,count_unlike,count_comments,title,const DeepCollectionEquality().hash(contents),created_at,is_notice,thumbnail);

@override
String toString() {
  return 'Article(key: $key, board_name: $board_name, profile_key: $profile_key, profile_name: $profile_name, count_view: $count_view, count_like: $count_like, count_unlike: $count_unlike, count_comments: $count_comments, title: $title, contents: $contents, created_at: $created_at, is_notice: $is_notice, thumbnail: $thumbnail)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _toString) String key,@JsonKey(fromJson: _toString) String board_name,@JsonKey(fromJson: _toString) String profile_key,@JsonKey(fromJson: _toString) String profile_name,@JsonKey(fromJson: _toInt) int count_view,@JsonKey(fromJson: _toInt) int count_like,@JsonKey(fromJson: _toInt) int count_unlike,@JsonKey(fromJson: _toInt) int count_comments,@JsonKey(fromJson: _toString) String title, List<ArticleContent> contents,@JsonKey(fromJson: _toString) String created_at, bool is_notice, String? thumbnail
});
...
as String,is_notice: null == is_notice ? _self.is_notice : is_notice // ignore: cast_nullable_to_non_nullable
...
class _Article implements Article {
  const _Article({@JsonKey(fromJson: _toString) required this.key, @JsonKey(fromJson: _toString) required this.board_name, @JsonKey(fromJson: _toString) required this.profile_key, @JsonKey(fromJson: _toString) required this.profile_name, @JsonKey(fromJson: _toInt) required this.count_view, @JsonKey(fromJson: _toInt) required this.count_like, @JsonKey(fromJson: _toInt) required this.count_unlike, @JsonKey(fromJson: _toInt) required this.count_comments, @JsonKey(fromJson: _toString) required this.title, required final  List<ArticleContent> contents, @JsonKey(fromJson: _toString) required this.created_at, required this.is_notice, this.thumbnail}): _contents = contents;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,key,board_name,profile_key,profile_name,count_view,count_like,count_unlike,count_comments,title,const DeepCollectionEquality().hash(_contents),created_at,is_notice,thumbnail);
...
/// Create a copy of Article
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? key = null,Object? board_name = null,Object? profile_key = null,Object? profile_name = null,Object? count_view = null,Object? count_like = null,Object? count_unlike = null,Object? count_comments = null,Object? title = null,Object? contents = null,Object? created_at = null,Object? is_notice = null,Object? thumbnail = freezed,}) {
