...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,board_name,profile_uid,profile_name,profile_photo_url,count_view,count_like,count_unlike,count_comments,title,const DeepCollectionEquality().hash(contents),created_at,is_notice,thumbnail);

@override
String toString() {
  return 'Article(id: $id, board_name: $board_name, profile_uid: $profile_uid, profile_name: $profile_name, profile_photo_url: $profile_photo_url, count_view: $count_view, count_like: $count_like, count_unlike: $count_unlike, count_comments: $count_comments, title: $title, contents: $contents, created_at: $created_at, is_notice: $is_notice, thumbnail: $thumbnail)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,board_name,profile_uid,profile_name,profile_photo_url,count_view,count_like,count_unlike,count_comments,title,const DeepCollectionEquality().hash(_contents),created_at,is_notice,thumbnail);
