...
@JsonKey(fromJson: _toString) String get id;@JsonKey(fromJson: _toDateTime) DateTime get bettingStartTime;@JsonKey(fromJson: _toDateTime) DateTime get bettingEndTime;@JsonKey(fromJson: _toDateTime) DateTime get startTime;@JsonKey(fromJson: _toDateTime) DateTime get endTime; List<Horse> get horses;@JsonKey(fromJson: _toBool) bool get isActive;@JsonKey(fromJson: _toBool) bool get isFinished;@JsonKey(fromJson: _toInt) int get currentRound;@JsonKey(fromJson: _toInt) int get totalRounds;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HorseRace&&(identical(other.id, id) || other.id == id)&&(identical(other.bettingStartTime, bettingStartTime) || other.bettingStartTime == bettingStartTime)&&(identical(other.bettingEndTime, bettingEndTime) || other.bettingEndTime == bettingEndTime)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime)&&const DeepCollectionEquality().equals(other.horses, horses)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.isFinished, isFinished) || other.isFinished == isFinished)&&(identical(other.currentRound, currentRound) || other.currentRound == currentRound)&&(identical(other.totalRounds, totalRounds) || other.totalRounds == totalRounds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,bettingStartTime,bettingEndTime,startTime,endTime,const DeepCollectionEquality().hash(horses),isActive,isFinished,currentRound,totalRounds);

@override
String toString() {
  return 'HorseRace(id: $id, bettingStartTime: $bettingStartTime, bettingEndTime: $bettingEndTime, startTime: $startTime, endTime: $endTime, horses: $horses, isActive: $isActive, isFinished: $isFinished, currentRound: $currentRound, totalRounds: $totalRounds)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _toString) String id,@JsonKey(fromJson: _toDateTime) DateTime bettingStartTime,@JsonKey(fromJson: _toDateTime) DateTime bettingEndTime,@JsonKey(fromJson: _toDateTime) DateTime startTime,@JsonKey(fromJson: _toDateTime) DateTime endTime, List<Horse> horses,@JsonKey(fromJson: _toBool) bool isActive,@JsonKey(fromJson: _toBool) bool isFinished,@JsonKey(fromJson: _toInt) int currentRound,@JsonKey(fromJson: _toInt) int totalRounds
});
...
/// Create a copy of HorseRace
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? bettingStartTime = null,Object? bettingEndTime = null,Object? startTime = null,Object? endTime = null,Object? horses = null,Object? isActive = null,Object? isFinished = null,Object? currentRound = null,Object? totalRounds = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,bettingStartTime: null == bettingStartTime ? _self.bettingStartTime : bettingStartTime // ignore: cast_nullable_to_non_nullable
...
as List<Horse>,isActive: null == isActive ? _self.isActive : isActive // ignore: cast_nullable_to_non_nullable
...
class _HorseRace implements HorseRace {
  const _HorseRace({@JsonKey(fromJson: _toString) required this.id, @JsonKey(fromJson: _toDateTime) required this.bettingStartTime, @JsonKey(fromJson: _toDateTime) required this.bettingEndTime, @JsonKey(fromJson: _toDateTime) required this.startTime, @JsonKey(fromJson: _toDateTime) required this.endTime, required final  List<Horse> horses, @JsonKey(fromJson: _toBool) required this.isActive, @JsonKey(fromJson: _toBool) required this.isFinished, @JsonKey(fromJson: _toInt) required this.currentRound, @JsonKey(fromJson: _toInt) required this.totalRounds}): _horses = horses;
...
@override@JsonKey(fromJson: _toDateTime) final  DateTime bettingStartTime;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HorseRace&&(identical(other.id, id) || other.id == id)&&(identical(other.bettingStartTime, bettingStartTime) || other.bettingStartTime == bettingStartTime)&&(identical(other.bettingEndTime, bettingEndTime) || other.bettingEndTime == bettingEndTime)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime)&&const DeepCollectionEquality().equals(other._horses, _horses)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.isFinished, isFinished) || other.isFinished == isFinished)&&(identical(other.currentRound, currentRound) || other.currentRound == currentRound)&&(identical(other.totalRounds, totalRounds) || other.totalRounds == totalRounds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,bettingStartTime,bettingEndTime,startTime,endTime,const DeepCollectionEquality().hash(_horses),isActive,isFinished,currentRound,totalRounds);
...
/// Create a copy of HorseRace
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? bettingStartTime = null,Object? bettingEndTime = null,Object? startTime = null,Object? endTime = null,Object? horses = null,Object? isActive = null,Object? isFinished = null,Object? currentRound = null,Object? totalRounds = null,}) {
...
@JsonKey(fromJson: _toString) String get coinId;@JsonKey(fromJson: _toString) String get name;@JsonKey(fromJson: _toString) String get symbol;@JsonKey(fromJson: _toString) String get image;@JsonKey(fromJson: _toDouble) double get currentPosition; List<double> get movements;@JsonKey(fromJson: _toDouble) double get lastPrice;@JsonKey(fromJson: _toDouble) double get previousPrice;@JsonKey(fromJson: _toInt) int get rank;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,coinId,name,symbol,image,currentPosition,const DeepCollectionEquality().hash(movements),lastPrice,previousPrice,rank);

@override
String toString() {
  return 'Horse(coinId: $coinId, name: $name, symbol: $symbol, image: $image, currentPosition: $currentPosition, movements: $movements, lastPrice: $lastPrice, previousPrice: $previousPrice, rank: $rank)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _toString) String coinId,@JsonKey(fromJson: _toString) String name,@JsonKey(fromJson: _toString) String symbol,@JsonKey(fromJson: _toString) String image,@JsonKey(fromJson: _toDouble) double currentPosition, List<double> movements,@JsonKey(fromJson: _toDouble) double lastPrice,@JsonKey(fromJson: _toDouble) double previousPrice,@JsonKey(fromJson: _toInt) int rank
});
...
/// Create a copy of Horse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? coinId = null,Object? name = null,Object? symbol = null,Object? image = null,Object? currentPosition = null,Object? movements = null,Object? lastPrice = null,Object? previousPrice = null,Object? rank = null,}) {
  return _then(_self.copyWith(
...
class _Horse implements Horse {
  const _Horse({@JsonKey(fromJson: _toString) required this.coinId, @JsonKey(fromJson: _toString) required this.name, @JsonKey(fromJson: _toString) required this.symbol, @JsonKey(fromJson: _toString) required this.image, @JsonKey(fromJson: _toDouble) required this.currentPosition, required final  List<double> movements, @JsonKey(fromJson: _toDouble) required this.lastPrice, @JsonKey(fromJson: _toDouble) required this.previousPrice, @JsonKey(fromJson: _toInt) required this.rank}): _movements = movements;
...
@override@JsonKey(fromJson: _toString) final  String image;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,coinId,name,symbol,image,currentPosition,const DeepCollectionEquality().hash(_movements),lastPrice,previousPrice,rank);
...
/// Create a copy of Horse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? coinId = null,Object? name = null,Object? symbol = null,Object? image = null,Object? currentPosition = null,Object? movements = null,Object? lastPrice = null,Object? previousPrice = null,Object? rank = null,}) {
  return _then(_Horse(
coinId: null == coinId ? _self.coinId : coinId // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,symbol: null == symbol ? _self.symbol : symbol // ignore: cast_nullable_to_non_nullable
...
@JsonKey(fromJson: _toString) String get horseId;@JsonKey(fromJson: _toInt) int get amount;@JsonKey(fromJson: _toDateTime) DateTime get betTime;@JsonKey(fromJson: _toBool) bool get isWon;@JsonKey(fromJson: _toInt) int get wonAmount;
...
@useResult
$Res call({
@JsonKey(fromJson: _toString) String id,@JsonKey(fromJson: _toString) String userId,@JsonKey(fromJson: _toString) String userName,@JsonKey(fromJson: _toString) String raceId,@JsonKey(fromJson: _toString) String betType,@JsonKey(fromJson: _toString) String horseId,@JsonKey(fromJson: _toInt) int amount,@JsonKey(fromJson: _toDateTime) DateTime betTime,@JsonKey(fromJson: _toBool) bool isWon,@JsonKey(fromJson: _toInt) int wonAmount
});
...
/// Create a copy of Bet
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? userName = null,Object? raceId = null,Object? betType = null,Object? horseId = null,Object? amount = null,Object? betTime = null,Object? isWon = null,Object? wonAmount = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as String,horseId: null == horseId ? _self.horseId : horseId // ignore: cast_nullable_to_non_nullable
...
class _Bet implements Bet {
  const _Bet({@JsonKey(fromJson: _toString) required this.id, @JsonKey(fromJson: _toString) required this.userId, @JsonKey(fromJson: _toString) required this.userName, @JsonKey(fromJson: _toString) required this.raceId, @JsonKey(fromJson: _toString) required this.betType, @JsonKey(fromJson: _toString) required this.horseId, @JsonKey(fromJson: _toInt) required this.amount, @JsonKey(fromJson: _toDateTime) required this.betTime, @JsonKey(fromJson: _toBool) required this.isWon, @JsonKey(fromJson: _toInt) required this.wonAmount});
...
// 'winner', 'top2', 'top3'
@override@JsonKey(fromJson: _toString) final  String horseId;
...
/// Create a copy of Bet
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? userName = null,Object? raceId = null,Object? betType = null,Object? horseId = null,Object? amount = null,Object? betTime = null,Object? isWon = null,Object? wonAmount = null,}) {
  return _then(_Bet(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,userId: null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String,userName: null == userName ? _self.userName : userName // ignore: cast_nullable_to_non_nullable
