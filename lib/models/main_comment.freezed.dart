...
@JsonKey(fromJson: _toString) String get key;@JsonKey(fromJson: _toString) String get contents;@JsonKey(fromJson: _toString) String get profile_key;@JsonKey(fromJson: _toString) String get profile_name;@JsonKey(fromJson: _toString) String get created_at;@JsonKey(fromJson: _toBool) bool get is_sub;@JsonKey(fromJson: _toString) String get parents_key;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,key,contents,profile_key,profile_name,created_at,is_sub,parents_key);

@override
String toString() {
  return 'MainComment(key: $key, contents: $contents, profile_key: $profile_key, profile_name: $profile_name, created_at: $created_at, is_sub: $is_sub, parents_key: $parents_key)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _toString) String key,@JsonKey(fromJson: _toString) String contents,@JsonKey(fromJson: _toString) String profile_key,@JsonKey(fromJson: _toString) String profile_name,@JsonKey(fromJson: _toString) String created_at,@JsonKey(fromJson: _toBool) bool is_sub,@JsonKey(fromJson: _toString) String parents_key
});
...
/// Create a copy of MainComment
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? key = null,Object? contents = null,Object? profile_key = null,Object? profile_name = null,Object? created_at = null,Object? is_sub = null,Object? parents_key = null,}) {
...
as String,is_sub: null == is_sub ? _self.is_sub : is_sub // ignore: cast_nullable_to_non_nullable
...
class _MainComment implements MainComment {
  const _MainComment({@JsonKey(fromJson: _toString) required this.key, @JsonKey(fromJson: _toString) required this.contents, @JsonKey(fromJson: _toString) required this.profile_key, @JsonKey(fromJson: _toString) required this.profile_name, @JsonKey(fromJson: _toString) required this.created_at, @JsonKey(fromJson: _toBool) required this.is_sub, @JsonKey(fromJson: _toString) required this.parents_key});
...
/// Create a copy of MainComment
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? key = null,Object? contents = null,Object? profile_key = null,Object? profile_name = null,Object? created_at = null,Object? is_sub = null,Object? parents_key = null,}) {
