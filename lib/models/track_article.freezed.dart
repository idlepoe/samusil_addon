...
@JsonKey(fromJson: _toString) String get id;@JsonKey(fromJson: _toString) String get profile_uid;@JsonKey(fromJson: _toString) String get profile_name;@JsonKey(fromJson: _toString) String get profile_photo_url;@JsonKey(fromJson: _toInt) int get count_view;@JsonKey(fromJson: _toInt) int get count_like;@JsonKey(fromJson: _toInt) int get count_unlike;@JsonKey(fromJson: _toInt) int get count_comments;@JsonKey(fromJson: _toInt) int get count_favorite;@JsonKey(fromJson: _toString) String get title; List<Track> get tracks;// contents 대신 tracks 사용
...
as int,count_favorite: null == count_favorite ? _self.count_favorite : count_favorite // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(fromJson: _toInt) final  int count_favorite;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,profile_uid,profile_name,profile_photo_url,count_view,count_like,count_unlike,count_comments,count_favorite,title,const DeepCollectionEquality().hash(_tracks),created_at,updated_at,profile_point,const DeepCollectionEquality().hash(_comments),total_duration,track_count,description);
