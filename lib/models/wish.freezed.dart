...
@JsonKey(fromJson: _toInt) int get index;@JsonKey(fromJson: _toString) String get uid;@JsonKey(fromJson: _toString) String get comments;@JsonKey(fromJson: _toString) String get nick_name;@JsonKey(fromJson: _toInt) int get streak;@JsonKey(fromJson: _toString) String get created_at;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,index,uid,comments,nick_name,streak,created_at);

@override
String toString() {
  return 'Wish(index: $index, uid: $uid, comments: $comments, nick_name: $nick_name, streak: $streak, created_at: $created_at)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _toInt) int index,@JsonKey(fromJson: _toString) String uid,@JsonKey(fromJson: _toString) String comments,@JsonKey(fromJson: _toString) String nick_name,@JsonKey(fromJson: _toInt) int streak,@JsonKey(fromJson: _toString) String created_at
});
...
/// Create a copy of Wish
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? index = null,Object? uid = null,Object? comments = null,Object? nick_name = null,Object? streak = null,Object? created_at = null,}) {
...
class _Wish implements Wish {
  const _Wish({@JsonKey(fromJson: _toInt) required this.index, @JsonKey(fromJson: _toString) required this.uid, @JsonKey(fromJson: _toString) required this.comments, @JsonKey(fromJson: _toString) required this.nick_name, @JsonKey(fromJson: _toInt) required this.streak, @JsonKey(fromJson: _toString) required this.created_at});
...
/// Create a copy of Wish
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? index = null,Object? uid = null,Object? comments = null,Object? nick_name = null,Object? streak = null,Object? created_at = null,}) {
  return _then(_Wish(
index: null == index ? _self.index : index // ignore: cast_nullable_to_non_nullable
as int,uid: null == uid ? _self.uid : uid // ignore: cast_nullable_to_non_nullable
as String,comments: null == comments ? _self.comments : comments // ignore: cast_nullable_to_non_nullable
